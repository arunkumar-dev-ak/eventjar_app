          ...
          children: [
            ...
            // If active, show the normal payment details
              ...
              if (isYou) ...[
                ...
                SizedBox(width: 1.wp),
                Text(
                  "${'paid'.tr} ${e.currency} ${e.amount.toStringAsFixed(2)}",
                  style: TextStyle(
                    fontSize: 8.5.sp,
                ...
                if (myParticipant?.isPaid == true) ...[
                  ...
                  SizedBox(width: 1.wp),
                  Text(
                    "${'paid'.tr} $currency ${myParticipant?.shareAmount.toStringAsFixed(2) ?? '0'}",
                    style: TextStyle(
                      fontSize: 8.5.sp,
                      color: Theme.of(context).brightness == Brightness.dark
                          ? Colors.green.shade300
                  ...
                  Text(
                    "${'my_share'.tr} $currency ${myParticipant?.shareAmount.toStringAsFixed(2) ?? '0'}",
                    style: TextStyle(
                      fontSize: 9.sp,
                      fontWeight: FontWeight.w600,
                      color: AppColors.textPrimary(context),
