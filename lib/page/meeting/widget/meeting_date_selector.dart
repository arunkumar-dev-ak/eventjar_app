...
class MeetingDateSelector extends StatelessWidget {
  final Rx<DateTime> selectedDate;
  final RxInt displayedMonth;
  final RxInt displayedYear;
  final VoidCallback onPreviousMonth;
  final VoidCallback onNextMonth;
  final void Function(int month, int year) onSetMonthYear;
  ...
  static Color accentColor(BuildContext context) {
    ...
    return isDark ? const Color(0xFF3A7BD5) : AppColors.gradientDarkStart;
  }
  ...
  void _showMonthYearPicker(BuildContext context) {
    var tempMonth = displayedMonth.value;
    var tempYear = displayedYear.value;
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 2.hp),
                  if (showYearGrid) ...[
                    _buildYearGrid(context, tempYear, accent, (year) {
                      setState(() {
                        tempYear = year;
                        showYearGrid = false;
                      });
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        onSetMonthYear(tempMonth, tempYear);
                        Navigator.pop(ctx);
                      },
...
class _DateItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedBg = MeetingDateSelector.accentColor(context);
